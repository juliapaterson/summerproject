...
for k = [8,9,20,21,22,23,33,34,35]
    ...
    for i = 2:10
        ...
        input = phase3.(input_name); %change this to change phase
...
save('phase3_frontal_face_complexities','all_face_complexities');
save('phase3_frontal_face_timestamps','all_face_timestamps');
...
save('phase3_frontal_random_complexities','all_random_complexities');
save('phase3_frontal_random_timestamps','all_random_timestamps');
