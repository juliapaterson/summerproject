...
for k = 4
    for i = 10
        file_name = strcat('ch',num2str(k),'_both_grouped_ms_L',num2str(i),'_state_series');
        ...
        face_plot_title = strcat('ch',num2str(k),'_ms_grouped_face_freq_ml',num2str(i),'.png');
        random_plot_title = strcat('ch',num2str(k),'_ms_grouped_random_freq_ml',num2str(i),'.png');
