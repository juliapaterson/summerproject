...
for k = 1
    for i = 10
        file_name = strcat('ch',num2str(k),'_both_short_L',num2str(i),'_state_series');
        ...
        face_plot_title = strcat('ch',num2str(k),'_short_source_freq_ml',num2str(i),'.png');
        random_plot_title = strcat('ch',num2str(k),'_short_source_freq_ml',num2str(i),'.png');
