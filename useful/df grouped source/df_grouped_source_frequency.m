...
for k = 1:4
    for i = 1:17
        ...
        face_plot_title = strcat('ch',num2str(k),'_df_grouped_face_freq_ml',num2str(i),'.png');
        random_plot_title = strcat('ch',num2str(k),'_df_grouped_random_freq_ml',num2str(i),'.png');
